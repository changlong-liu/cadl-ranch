...
Scenarios.DPGAddOptionalInput_NoParams = passOnSuccess(
  mockapi.head("/resiliency/servicedriven1/parameters", (req) => {
    return {
      status: 200,
...
Scenarios.DPGAddOptionalInput = passOnSuccess(
  mockapi.get("/resiliency/servicedriven1/parameters", (req) => {
...
Scenarios.DPGAddOptionalInput_RequiredOptionalParam = passOnSuccess(
  mockapi.put("/resiliency/servicedriven1/parameters", (req) => {
...
Scenarios.DPGAddOptionalInput_OptionalParam = passOnSuccess(
  mockapi.get("/resiliency/servicedriven1/moreParameters", (req) => {
    return {
      status: 200,
      body: json({ message: `An object was successfully returned` }),
    };
...
Scenarios.DPGNewBodyTypeJSON = passOnSuccess(
  mockapi.post("/resiliency/servicedriven1/parameters/json", (req) => {
...
Scenarios.DPGNewBodyTypeJPEG = passOnSuccess(
  mockapi.post("/resiliency/servicedriven1/parameters/jpeg", (req) => {
    switch (req.headers["content-type"]) {
      case "image/jpeg":
...
Scenarios.DPGAddNewOperation = passOnSuccess(
  mockapi.delete("/resiliency/servicedriven1/parameters", (req) => {
    return {
      status: 204,
    };
  }),
...
Scenarios.DPGAddNewPath = passOnSuccess(
  mockapi.get("/resiliency/servicedriven1/newpath", (req) => {
    return {
      status: 200,
      body: json({ message: `An object was successfully returned` }),
    };
...
Scenarios.DPGGlassBreaker = passOnSuccess(
  mockapi.get("/resiliency/servicedriven1/glassbreaker", (req) => {
    return {
      status: 200,
      body: json({ message: `An object was successfully returned` }),
    };
